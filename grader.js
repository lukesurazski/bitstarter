...
var buildfn = function(url, checks) {
    var responseCheckHtmlFile = function(result, response) {
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <html_file>', 'URL to index.html', clone(assertHtmlFileExists))
        .parse(process.argv);
    if (program.url) {
	var responseFn = buildfn(program.url, program.checks);
